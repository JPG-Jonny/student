// =========================================================================
        ...
        const state = {
            ...
            students: [
                { id: 'STU202601', name: 'Alex Morgan', email: 'alex.m@univ.edu', phone: '+1 (555) 234-5678', department: 'Computer Science', program: 'B.S. Software Engineering', semester: 6, enrollmentYear: 2023, cgpa: 3.82, totalCredits: 88, attendancePct: 88.5, avatar: 'AM' },
                { id: 'STU202602', name: 'Brendan Eich', email: 'brendan@univ.edu', phone: '+1 (555) 876-5432', department: 'Computer Science', program: 'B.S. Computer Science', semester: 6, enrollmentYear: 2023, cgpa: 3.45, totalCredits: 82, attendancePct: 71.2, avatar: 'BE' }, // Low attendance demo
                { id: 'STU202603', name: 'Catherine Zeta', email: 'czeta@univ.edu', phone: '+1 (555) 345-6789', department: 'Data Science', program: 'B.S. Data Analytics', semester: 4, enrollmentYear: 2024, cgpa: 3.91, totalCredits: 56, attendancePct: 94.0, avatar: 'CZ' },
                { id: 'STU202604', name: 'David Miller', email: 'dmiller@univ.edu', phone: '+1 (555) 901-2345', department: 'Electrical Eng.', program: 'B.S. Electrical Eng', semester: 2, enrollmentYear: 2025, cgpa: 2.95, totalCredits: 28, attendancePct: 64.5, avatar: 'DM' }, // Low attendance demo
                { id: 'STU202605', name: 'Elena Rostova', email: 'elena@univ.edu', phone: '+1 (555) 456-7890', department: 'Mechanical Eng.', program: 'B.S. Robotics', semester: 8, enrollmentYear: 2022, cgpa: 3.76, totalCredits: 112, attendancePct: 91.2, avatar: 'ER' }
            ],

            faculties: [
                { id: 'FAC101', name: 'Dr. Robert Vance', department: 'Computer Science', email: 'r.vance@univ.edu', course: 'CS302 - Algorithms', avatar: 'RV' },
                { id: 'FAC102', name: 'Prof. Sarah Lin', department: 'Data Science', email: 's.lin@univ.edu', course: 'DS201 - Database Systems', avatar: 'SL' }
            ],

            assignments: [
                { id: 'ASN-101', title: 'Dynamic Programming & Graph Optimization', subject: 'CS302 - Algorithms', faculty: 'Dr. Robert Vance', dueDate: '2026-09-02', description: 'Implement Dijkstra and Bellman-Ford algorithms in Python with performance benchmarking visuals.', status: 'Pending', marks: 'N/A', feedback: '', maxMarks: 100 },
                { id: 'ASN-102', title: 'SQL Relational Schema & Indexing Lab', subject: 'DS201 - Database Systems', faculty: 'Prof. Sarah Lin', dueDate: '2026-08-20', description: 'Design a database schema for an ERP system with complex queries and foreign key constraints.', status: 'Graded', marks: '94/100', feedback: 'Excellent ER diagram normalization. Clean queries.', maxMarks: 100 },
                { id: 'ASN-103', title: 'Distributed Microservices Architecture', subject: 'CS304 - Web Systems', faculty: 'Dr. Vance', dueDate: '2026-08-28', description: 'Containerize node services with Docker Compose.', status: 'Submitted', marks: 'Pending', feedback: 'Under review by faculty.', maxMarks: 50 },
                { id: 'ASN-104', title: 'Neural Network Optimization & Hyperparameters', subject: 'AI401 - Machine Learning', faculty: 'Prof. K. Sharma', dueDate: '2026-08-15', description: 'Train a CNN model on CIFAR-10 and present error rate curves.', status: 'Late', marks: '70/100', feedback: 'Submitted 2 days late. Penalty applied.', maxMarks: 100 }
            ],

            attendanceRecords: [
                { subject: 'CS302 - Algorithms', totalClasses: 32, attended: 29, pct: 90.6 },
                { subject: 'DS201 - Database Systems', totalClasses: 28, attended: 26, pct: 92.8 },
                { subject: 'CS304 - Web Systems', totalClasses: 30, attended: 21, pct: 70.0 }, // warning
                { subject: 'AI401 - Machine Learning', totalClasses: 25, attended: 24, pct: 96.0 }
            ],

            activities: [
                { id: 'ACT-1', title: '1st Place - National Inter-University Hackathon', category: 'Academic/Competition', date: '2026-05-14', organization: 'TechCorp Alliance', description: 'Developed an AI emergency routing algorithm under 24 hours.', certificateStatus: 'Verified' },
                { id: 'ACT-2', title: 'Machine Learning Research Assistant', category: 'Projects/Research', date: '2026-02-10', organization: 'Univ AI Research Lab', description: 'Assisted in data preprocessing for medical imaging diagnostic model.', certificateStatus: 'Verified' },
                { id: 'ACT-3', title: 'Student Council Technical Lead', category: 'Extracurricular', date: '2025-09-01', organization: 'Student Union', description: 'Managed technical infrastructure for annual university fest.', certificateStatus: 'Pending Verification' }
            ],

            creditTransfers: [
                { id: 'TRF-8801', studentId: 'STU202601', studentName: 'Alex Morgan', sourceInst: 'MIT Open Courseware', destInst: 'EduPulse Univ', course: 'Advanced Discrete Math', credits: 4, grade: 'A', status: 'Approved', requestDate: '2026-06-12' },
                { id: 'TRF-8802', studentId: 'STU202601', studentName: 'Alex Morgan', sourceInst: 'Stanford Online', destInst: 'EduPulse Univ', course: 'Quantum Computing Intro', credits: 3, grade: 'A-', status: 'Pending', requestDate: '2026-08-10' },
                { id: 'TRF-8803', studentId: 'STU202603', studentName: 'Catherine Zeta', sourceInst: 'ETH Zurich Exchange', destInst: 'EduPulse Univ', course: 'Data Visualization & Ethics', credits: 5, grade: 'B+', status: 'Pending', requestDate: '2026-08-22' }
            ]
        };
        ...
        function setAuthRole(role) {
            ...
            // Setup registration fields context
        ...
        function handleLogin(e) {
            e.preventDefault();
            // Assign logged user state according to role selected
            if (state.currentRole === 'student') {
                state.currentUser = state.students[0];
                state.activeTab = 'home';
            } else if (state.currentRole === 'faculty') {
                state.currentUser = state.faculties[0];
        ...
        function handleRegister(e) {
            ...
            if (state.currentRole === 'student') {
                ...
                const newFaculty = {
                    ...
                    department: dept,
                    email: email,
                    course: dept + ' Specialization',
                    avatar: name.split(' ').map(n=>n[0]).join('').toUpperCase()
                };
                state.faculties.push(newFaculty);
                state.currentUser = newFaculty;
                state.activeTab = 'dashboard';
            } else {
                state.currentUser = { name: name, email: email, role: 'admin' };
                state.activeTab = 'dashboard';
            }
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gradient-to-r from-blue-700 to-indigo-800 text-white rounded-2xl p-6 shadow-lg flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-blue-200 text-sm mt-0.5">${s.program} â€¢ Semester ${s.semester} (${s.id})</p>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div onclick="switchTab('attendance')" class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 hover:shadow-md transition-all cursor-pointer">
                            ...
                            <div class="text-2xl font-bold text-slate-800">${s.attendancePct}%</div>
                            <div class="mt-2 w-full bg-slate-100 rounded-full h-2">
                                <div class="bg-emerald-500 h-2 rounded-full" style="width: ${s.attendancePct}%"></div>
                            </div>
                            <p class="text-xs ${s.attendancePct < 75 ? 'text-amber-600 font-semibold' : 'text-slate-500'} mt-2">
                                ${s.attendancePct < 75 ? 'âš ï¸ Warning: Below 75% limit' : 'Good standing overall'}
                            </p>
                        </div>
                        ...
                        <div onclick="switchTab('progress')" class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 hover:shadow-md transition-all cursor-pointer">
                            ...
                            <div class="text-2xl font-bold text-slate-800">${s.cgpa} / 4.00</div>
                        ...
                        <div onclick="switchTab('credits')" class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 hover:shadow-md transition-all cursor-pointer">
                            ...
                            <div class="text-2xl font-bold text-slate-800">${s.totalCredits} / 120</div>
                            <div class="mt-2 w-full bg-slate-100 rounded-full h-2">
                                <div class="bg-indigo-600 h-2 rounded-full" style="width: ${(s.totalCredits/120)*100}%"></div>
                            </div>
                            <p class="text-xs text-slate-500 mt-2">${120 - s.totalCredits} credits remaining</p>
                        </div>
                    </div>

                    <!-- Split Section: Upcoming Deadlines & Recent Activities -->
                                ...
                                ${state.assignments.map(a => `
                                    <div class="p-3 rounded-xl border border-slate-100 bg-slate-50 flex items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">${a.subject} â€¢ Due: ${a.dueDate}</p>
                                        </div>
                                ...
                                ${state.activities.map(act => `
                                    <div class="p-3 rounded-xl border border-slate-100 bg-slate-50 flex items-start justify-between">
                                        <div>
                                            ...
                                            <p class="text-xs text-slate-500">${act.category} â€¢ ${act.date}</p>
                                        </div>
            ...
            return list.map(a => `
                <div class="p-5 rounded-xl border border-slate-200 bg-slate-50/50 hover:bg-white hover:shadow-md transition-all flex flex-col justify-between gap-4">
                    <div>
                        ...
                        <p class="text-xs font-semibold text-blue-600 mb-2">${a.subject} â€¢ ${a.faculty}</p>
        ...
        function openSubmitModal(asnId) {
            ...
            openModal(`
                <div class="space-y-4">
                    ...
                    <p class="text-xs text-slate-500">${asn.subject} â€¢ Faculty: ${asn.faculty}</p>
                    ...
                    ${asn.status === 'Pending' ? `
                        <form onsubmit="submitAssignment(event, '${asn.id}')" class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea class="w-full border border-slate-200 rounded-lg p-2 text-xs focus:ring-2 focus:ring-blue-500" rows="3" placeholder="Add optional comments for faculty..."></textarea>
                            </div>
                    ...
                    ` : `
                        <div class="bg-emerald-50 border border-emerald-200 p-4 rounded-xl text-center space-y-2">
                            ...
                            <p class="text-xs text-emerald-700">Status: ${asn.status} | Marks: ${asn.marks}</p>
                        </div>
                    `}
                </div>
            `);
        ...
        function renderStudentAttendance() {
            const overall = state.currentUser.attendancePct;
            return `
                <div class="space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div class="p-4 rounded-xl bg-emerald-50 border border-emerald-100">
                                ...
                                <p class="text-2xl font-bold text-emerald-900 mt-1">${state.currentUser.totalCredits}</p>
                            </div>
                            <div class="p-4 rounded-xl bg-slate-100 border border-slate-200">
                                ...
                                <p class="text-2xl font-bold text-slate-800 mt-1">${120 - state.currentUser.totalCredits}</p>
                            </div>
                        </div>
                    </div>
        ...
        function submitCreditTransfer(e) {
            e.preventDefault();
            const newTrf = {
                        ...
                        ${state.activities.map(act => `
                            <div class="relative">
                                ...
                                <div class="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-1">
                                    ...
                                    <p class="text-xs font-medium text-slate-500">${act.organization} â€¢ ${act.date}</p>
            ...
            return `
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 max-w-2xl mx-auto space-y-6">
                    <div class="flex justify-between items-center border-b pb-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500">${s.id} â€¢ ${s.department}</p>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 text-xs">
                        ...
                        <div><span class="text-slate-400 block uppercase">Phone</span><span class="font-semibold text-slate-800">${s.phone}</span></div>
                        <div><span class="text-slate-400 block uppercase">Program</span><span class="font-semibold text-slate-800">${s.program}</span></div>
                        <div><span class="text-slate-400 block uppercase">Semester</span><span class="font-semibold text-slate-800">${s.semester}</span></div>
                        <div><span class="text-slate-400 block uppercase">Enrollment Year</span><span class="font-semibold text-slate-800">${s.enrollmentYear}</span></div>
                        <div><span class="text-slate-400 block uppercase">Current CGPA</span><span class="font-semibold text-emerald-600">${s.cgpa}</span></div>
                    </div>
                </div>
            `;
        }
            ...
            return `
                <div class="space-y-6">
                    <div class="bg-slate-900 text-white rounded-2xl p-6 shadow-md">
                        ...
                        <p class="text-xs text-slate-400 mt-1">${state.currentUser.name} â€¢ ${state.currentUser.department}</p>
                    </div>
        ...
        function saveGrade(e, id) {
            e.preventDefault();
            const asn = state.assignments.find(a => a.id === id);
            asn.marks = document.getElementById('grade-val').value;
            asn.feedback = document.getElementById('grade-feedback').value;
            asn.status = 'Graded';
            closeModal();
            renderView();
        }
        ...
        function toggleStudentAttendance(id) {
            ...
            s.attendancePct = s.attendancePct >= 90 ? 70.0 : 95.0; // Dynamic toggle demonstration
            renderView();
        }
                            ...
                            <tbody class="divide-y divide-slate-100">
                                ${state.students.map(s => `
                                    <tr>
                                        ...
                                        <td class="p-3 font-bold text-blue-600">${s.cgpa}</td>
                                        <td class="p-3">
                                            <span class="${s.attendancePct < 75 ? 'text-amber-600 font-bold' : 'text-slate-700'}">${s.attendancePct}%</span>
                                        </td>
                                    </tr>
                                `).join('')}
                            </tbody>
                        ...
                        ${state.creditTransfers.map(t => `
                            <div class="p-4 border rounded-xl bg-slate-50 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-xs">
                                <div>
                                    ...
                                    <p class="text-slate-500">${t.course} â€¢ ${t.credits} Credits from ${t.sourceInst}</p>
